...
export interface StartDuelData {
  /** @example "mais bonito" */
  theme: string;
  /** @example 45 */
  duelId: number;
  ...
  person2Id: number;
  /**
   * The raw data of the image of the first person encoded in base64
  ...
  image1b64: string;
  /**
   * The raw data of the image of the second person encoded in base64
...
export type PickWinnerData = any;

export type GetRankingData = {
  name: string;
  id: number;
  /** The raw data of the image of the thing encoded in base64 */
  image: string;
  points: number;
}[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  duel = {
     ...
     * @request GET:/duel
     */
    startDuel: (params: RequestParams = {}) =>
      this.request<StartDuelData, void>({
        path: `/duel`,
        method: "GET",
        format: "json",
        ...params,
     ...
     * @request POST:/duel/pickWinner
     */
    pickWinner: (data: PickWinnerPayload, params: RequestParams = {}) =>
      this.request<PickWinnerData, void>({
        path: `/duel/pickWinner`,
        method: "POST",
        body: data,
  ...
  ranking = {
     ...
     * @request GET:/ranking
     */
    getRanking: (params: RequestParams = {}) =>
      this.request<GetRankingData, void>({
        path: `/ranking`,
        method: "GET",
        format: "json",
        ...params,
